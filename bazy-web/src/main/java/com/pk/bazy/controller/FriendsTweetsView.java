...
@ManagedBean(name = "friendsTweetsView")
@ViewScoped
public class FriendsTweetsView {
	...
	public void init(){
		...
		if (userName == null || userName.isEmpty()) {
			friends = session.getDao().getFriendsWithTweets(session.getUser());
		} else {
			friends = session.getDao().getFriendsWithTweets(new User(userName));
		}
	}
